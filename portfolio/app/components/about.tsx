        ...
        <section ref={sectionRef} id="about" className="relative py-32 md:py-48 bg-gradient-to-b from-black via-zinc-900/50 to-black overflow-hidden intro-section">
            ...
            <div className="container relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto">
                    {/* Large card - Bio */}
                    <div
                        className={`md:col-span-3 glass-panel p-8 md:p-16 rounded-3xl transition-all duration-1000 delay-100 hover:border-purple-500/30 hover:shadow-2xl hover:shadow-purple-500/10 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                            }`}
                    >
                        <div className="flex flex-col md:flex-row gap-12 items-center md:items-start text-center md:text-left">
                            <div className="shrink-0">
                                <span className="w-24 h-24 md:w-32 md:h-32 rounded-3xl bg-gradient-to-br from-purple-500 via-indigo-500 to-blue-500 flex items-center justify-center text-4xl md:text-5xl shadow-2xl shadow-purple-500/30 ring-2 ring-white/10">
                                    👋
                                </span>
                            </div>
                            <div className="flex-grow">
                                <h3 className="text-4xl md:text-5xl font-bold text-white mb-8 tracking-tight">
                                    Hi, I'm <span className="text-gradient">Yogesh Thapa</span>
                                </h3>
                                <div className="space-y-6">
                                    <p className="text-gray-300 text-xl leading-relaxed font-light">
                                        I'm a passionate <span className="text-white font-medium">full-stack developer</span> with a keen eye for design and a love for creating
                    ...
                    >
                        ...
                        <p className="text-gray-500 text-sm">Janajyoti Multiple Campus, Nepal | 2020-2025</p>
                    </div>
