...
const educationItems: EducationItem[] = [
  {
    ...
    highlights: ['Graduated Magna Cum Laude', 'Completed capstone project on AI applications.'],
  ...
  },
  {
    ...
    period: '2022',
    location: 'Remote',
    description: 'Certified in cloud architecture and AWS best practices.',
    highlights: ['Deployed scalable applications on AWS.', 'Expertise in VPC, IAM, ECS'],
    icon: 'CloudIcon',
    type: 'certification',
    accentColor: 'gold',
  },
  {
    ...
    period: '2020',
    location: 'Remote',
    description: 'Intensive coding bootcamp focused on the MERN stack.',
    highlights: ['Built multiple full-stack applications.', 'Optimized complex backend architectures.'],
  ...
  },
  {
    ...
    period: '2023',
    location: 'Remote',
    description: 'Proficient in React, JavaScript, and modern frontend tools.',
    highlights: ['Completed projects using responsive design.', 'Top 5% of cohort performance.'],
    icon: 'StarIcon',
    type: 'certification',
    accentColor: 'purple',
  },
